...
class Car {
    ...
    /*
        ...
        cf) void 반환타입
            : 해당 메서드(함수, 행동)의 반환하는 결과가 X 때 사용
    ...
    Car(String modelName, int year) {
        ...
        public class Object03 {
            public static void main(String[] args) {
                ...
                // 생성자 호출 : 생성자명(필요함 매개변수...)

                // 해당 객체에 대한 참조(주소)를 클래스 타입의 변수에 저장
                Car myCar = new Car("0volve xc60", 2024);

                // === 객체 사용 ===
                // : 연결자를 사용하여 객체 내부의 필드와 메서드 이용
                ...
                // cj) 클래스 타임
                // 지정된 클래스를 기반으로 생성된 객체임으로 클래스 자제츠이 타입을 지임
