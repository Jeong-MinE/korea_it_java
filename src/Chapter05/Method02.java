...
/*
    ...
    2) 매개변수(parameter) 선언
    - 메서드의 작업을 수행하는데 필요한 값들을 제공받기 위한 것
    - 필요한 값의 개수만큼 변수를 선언, 데이터 타입과 변수명을 쉽표(,)로 구분하여 나열
    ...
    2. 메서드의 구현부
    : 메서드 선언부 다음에 오는 중괄호{}
    : 반환타입이 void가 아닐 경우 reture문을 반드시 포함!
    - 해당 반환값은 반환타입과 일치하거나 자동형 반환이 가능한 데이터
...
public class Method02 {
    public static void main(String[] args) {
        ...
        // example.add(1);
        // example.add(10, 20, 30); - Error (인자 값은 매개변수의 수와 같아야 한다.)
        // example.add("10", "20"); - Error (인자 값은 매개변수의 타입과 같거나 자동형변환이 가능해야한다.
        example.add('a','b'); // char 타입(2) >> int (타입 4) : 자동형변환
