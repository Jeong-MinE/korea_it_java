...
public class A_Variable {
    public static void main(String[] args) {
        ...
        // = 변수 명명 규칙 =
        // : 문자, 숫자, 기호 사용
        // - 대소문자를 구분, 길이 제한 X (Name, name이 다르다.)
        // - 숫자로 시작X
        // - 기호는 _(언더스코어)와 $(달러)만 가능(시작가능)
        ...
        // cher num24 ='가'; - 변수는 재할당은 가능하나, 재선언은 불가능

        int height = 167;
        height = 167; // 키는 변할 수 있는 변수값
