...
public class E_Operation {
    public static void main(String[] args) {
        ...
        System.out.println(number++); // 값 == 10
        System.out.println(number--); // 값 == 11
        ...
        System.out.println(y % x == 0 ? "2의 배수입니다." : "2의 배수가 아닙니다.");
        ...
        // 괄호 연산자 : 우선순위를 명시적으로 지정할 때 ()(소괄호) 사용
        int num = (1 + 3) * 4;
