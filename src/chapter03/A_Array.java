package chapter03;
    ...
    // EX) 학생들의 시험 점수를 저장, 여러 개의 문자열을 다룰 때 사용
...
public class A_Array {
    public static void main(String[] args) {
        ...
        // === 배열의 생성 ===
        // : 실제 데이터가 저장 x, 데이터 배열이 저장된 첫 번 째 메모리 주소가 저장
        // >> new 데이터타입[배열의 길이];
        ...
        // System.out.println(array[3]); - 범위 외 내용은 오류
        ...
        for (int i = 0; i < original.length; i++) {
            if (i == removeIndex) {
                continue; // 루프의 나머지 부분을 건너뛰고 다음 방복을 진행
            }
