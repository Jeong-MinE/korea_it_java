...
public class StudentManagementApp {
    ...
    //      +) 프로그램 시작 시 JVM이 접근해야하기 때문에 반드시 public 설정!
    ...
    public static void main(String[] args) {
        // 학생 추가
        addStudent(1, "차정민", 28, "GPT반", 4.0);
        addStudent(2, "아우아", 30, "IOT반", 3.8);
        addStudent(3, "에에에", 24, "GPT반", 4.3);
        addStudent(4, "우돠아", 35, "GPT반", 4.2);
    ...
    //  : main 메서드 내부에서 다른 메서드를 호출하려면 해당 메서드는 static이여야 함!
