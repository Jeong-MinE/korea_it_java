...
public class JavaUtil {
    public static void main(String[] args) {
        ...
        // 2) getTime() : 1970년 1월 1일을 00:00:00 (UTC)을 기준으로 현재 시간까지의 밀리초(ms)를 반환
        // UTC : 시간대의 기준점 (한국 == UTC + 9:00)
        // 오늘날짜 + 09:00 - 어제 날짜 + 9:00/
        System.out.println("현재 시간의 밀리초: " + date.getTime());

        System.out.println("===========Calendar===========");
        // 2. Calendar 클래스
        // 1) getInstance() : 현재 날짜와 시간으로 초기화된 Calendar 객체를 반환
        Calendar calendar = Calendar.getInstance(); // static 클래스
