...
public class C_ListPractice {
    public static void main(String[] args) {
        ...
        eventManagement.addParticipant("차정민");
        ...
        eventManagement.addToWaitingQueue("김소미");
        eventManagement.addToWaitingQueue("정규빈");
        eventManagement.addToWaitingQueue("박성우");

        System.out.println(eventManagement.participantList);
        System.out.println(eventManagement.waitingQueue);

        eventManagement.leaveParticipant("차정민");
        System.out.println(eventManagement.participantList);

        eventManagement.leaveParticipant("이지훈");
        System.out.println(eventManagement.participantList);

        System.out.println(eventManagement.checkParticipant("김명진"));
        System.out.println(eventManagement.checkParticipant("박성우"));
