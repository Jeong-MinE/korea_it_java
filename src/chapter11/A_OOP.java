...
// - 업캐스팅 상태에서 부모의 메서드를 사용 시 동작이 가능
...
class Penguin extends Bird {
    @Override
    void fly() { // 펭귄은 '새'를 상속받지만 부모 클래스(Bird)에 fly 메서드가 가지는 동작이 의도대로 구현되지 X
        System.out.println("펭귄은 날 없습니다.");
    }
}
