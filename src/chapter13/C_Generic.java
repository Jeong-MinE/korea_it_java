...
// : 할인 정책을 정요할 때,
//      힐인은 Product 또는 Product를 상속받는 하위 클래스에서만 적용
...
public class C_Generic {
    public static void main(String[] args) {
        ...
        electronics.add(new Electronics("내장고", 257));
        ...
        furnituresList.add(new Furniture("침대", 230));
        furnituresList.add(new Furniture("쇼파", 260));
        furnituresList.add(new Furniture("화장대", 80));

        double totalFurnitureList = DiscountPolicy.applyDiscount(furnituresList, 0.2);

        System.out.println("총 가구 할인액: " + totalElectronics + "원");
