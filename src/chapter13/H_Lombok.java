...
// 4. @Data 어노테이션
// : @Setter, @Getter, @toString, @RequiredArgsConstructor, @EqualsAndHasHCode 어노테이션을 한 번에 적용하는 어노테이션
...
//       toString 메서드 : Object 객체 클래스 내의 메서드
...
// build 메서드 내에서 호출될 생성자
// : Builder 패턴으로 만들어진 필드값들을 전달 받은 생성자
//public LombokClass(Builder builder) {
//    this.title = title;
}
