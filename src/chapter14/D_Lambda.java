...
interface MyFunctionalInterface {
    ...
    // : @FunctionalInterface는 하나의 추상 메서드먼 가짐
}
...
public class D_Lambda {
    public static void main(String[] args) {
        ...
        System.out.println("익명 테스트 결과: " + calculator1.add(3, 5));
        ...
        // 3) 매개변수가 한 개인 방식
        OneParams oneParams = message -> System.out.println("출력 메시지: " + message);
        oneParams.print("안녕");
        ...
        System.out.println("문자열 길이: " + stringLength.getLength("Lambda"));
