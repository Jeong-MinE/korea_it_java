...
// === 스트림 API의 최종 연산 === //
// collect 메서드
// : 스트림의 요소를 변환하거나 집계해서 최종 결과를 생성하는데 사용
// - 스트림의 종결 작업 중 하나
...
//      : 다양한 Collector를 제공하여 collect 메서드와 결합해하나의 결과를 반환
...
public class B_collect {
    public static void main(String[] args) {
        ...
        List<String> uppercaseLanguages = languages.stream()
                ...
                .map(String::toUpperCase) // 문자열을 대문자로 변경 - 메섣 ㅡ참조
        ...
        System.out.println(partitinoned);
