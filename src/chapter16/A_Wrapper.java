...
*
*      단점
*       - 객체를 생성하는 과정에서 추가적인 메모리 사용량이 증가되어 박싱, 언박싱 과정에서 성능 저하가 발생할 수 있음.
*       - null 값이 할당될 수 있는 Wrapper 객체를 언박싱할 경우, NullPointerException 발생 위험이 있음
*
...
//        new Integer("안녕하세요");
        ...
        System.out.println(result); // 호출 객체(myInteger가 더 작음 [음수])
    }
}
