...
public class ReservationController {
    ...
    private void displayMenu() {
        ...
        System.out.println("4. 예약등록 | 5. 예약 확인 | 6. 예약취소");
        System.out.println("7. 종료");
        System.out.println("선택 : ");
    }

    private int getChoice(Scanner scanner) {
        // Scanner 클래스의 hasNextInt()
        // : Scanner 객체에 입력된 값이 int값일 경우에 ture, 그렇지 않으면 false 반환
    ...
    private boolean processChoice(int choice, Scanner scanner) {
        ...
        switch (choice) {
            ...
            case 5:
                // 예약 확인
                List<Reservation> result = reservationService.getReservationsByUserId(
                        input(scanner, "사용자 ID")
